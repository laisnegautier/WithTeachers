    ...
    public partial class InitialTest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseDocumentId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoconferenceId1 = table.Column<string>(nullable: true),
                    CourseId = table.Column<int>(nullable: false),
                    ClassId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Activities_Videoconferences_VideoconferenceId1",
                        column: x => x.VideoconferenceId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_VideoconferenceId1",
                table: "Activities",
                column: "VideoconferenceId1");
