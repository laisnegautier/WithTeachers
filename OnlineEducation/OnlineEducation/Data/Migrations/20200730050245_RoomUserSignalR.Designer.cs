...
namespace OnlineEducation.Data.Migrations
{
    ...
    [Migration("20200730050245_RoomUserSignalR")]
    partial class RoomUserSignalR
    {
            ...
            modelBuilder.Entity("OnlineEducation.Data.Models.Videoconference", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsCompleted = false,
                            IsOngoing = true,
                            ScheduledFor = new DateTime(2020, 7, 30, 7, 2, 44, 941, DateTimeKind.Local).AddTicks(4300),
                        ...
                        new
                        {
                            ...
                            IsCompleted = false,
                            IsOngoing = true,
                            ScheduledFor = new DateTime(2020, 7, 30, 7, 2, 44, 944, DateTimeKind.Local).AddTicks(7103),
            ...
            modelBuilder.Entity("OnlineEducation.Data.Models.UserRoom", b =>
                {
                    ...
                    b.HasOne("OnlineEducation.Data.Models.VideoconferenceUser", "User")
                        .WithMany("UserRooms")
                        .HasForeignKey("VideoconferenceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
